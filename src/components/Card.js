      ...
      <div className="rounded-2xl shadow-2xl">
        ...
        <div className="p-2 md:p-5">
          <p className="font-title text-left text-lg lg:text-2xl mb-3">
            <CustomHighlight hit={hit} attribute="project_name" />
            <p className="text-sm">
              <CustomHighlight hit={hit} attribute="builder_name" />
            </p>
          </p>
          ...
          <div className="flex items-center justify-between">
            <div className="flex w-auto items-center">
              ...
              <div className="text-left sm:ml-5 text-xs xl:text-base font-body">
                <CustomHighlight hit={hit} attribute="street_name" />
                <br />
                <CustomHighlight hit={hit} attribute="city_facet" />
                <br />
                <p className="">
